  ...
  return (
    <div className="flex flex-col items-center bg-gray-50 min-h-screen py-12">
      ...
      <section className="w-full max-w-6xl my-5    px-4 text-center">
        ...
        <h2 className="text-4xl font-bold text-gray-900 mt-8">See HypoGo in Action</h2>
        <p className="text-lg text-gray-600 mt-4">
          Watch how HypoGo can transform the way you work, learn, and grow. Our tools are designed to empower you every step of the way.
        </p>
      </section>
